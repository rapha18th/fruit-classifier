...
```
After follwing these steps in order we should save(and commit) our notebook that way we get output which contains the model we just saved as a serialised object for use in production.
